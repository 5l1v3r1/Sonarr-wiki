...
No. Sonarr will talk to your download client to determine where the files have been downloaded and will import them automatically automatically. [[Sorting and Renaming]]. If Sonarr and your download client are on different machines you will need to use Remote Path Mapping to link the remote path to a local one so Sonarr knows where to find the files.
